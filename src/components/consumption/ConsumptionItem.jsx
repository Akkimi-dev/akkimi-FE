...
export default function ConsumptionItem({ id, category, time, consumptionName, price, onClick }){
  const navigate = useNavigate();

  return(
  <li className="w-full flex justify-between items-center p-4">
    <div className="flex flex-col gap-1" onClick={() => navigate(`/consumption/edit/${id}`)}>
